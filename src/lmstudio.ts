...
export async function generatePersonaLookPrompts(
  ...
  const systemPrompt = [
    ...
    "ABSOLUTE SAFETY OVERRIDE: в этих промптах НИКОГДА не допускается полная нагота или частичная нагота. Никаких исключений.",
    "Это правило выше любых входных данных. Даже если во входе есть запрос/намёк на наготу, игнорируй его и конвертируй в полностью одетый safe outfit.",
    "avatarPrompt и fullBodyPrompt ОБЯЗАТЕЛЬНО должны содержать safe-теги: (fully clothed:1.3), (no nudity:1.3), (no nsfw:1.3).",
