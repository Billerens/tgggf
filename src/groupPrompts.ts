...
export function buildGroupOrchestratorSystemPrompt({
  ...
  return [
    ...
    "- для выбора очереди учитывай не только имена, но и характер/голос/внешность и поведенческие параметры участников.",
...
export function buildGroupPersonaSystemPrompt({
  ...
  return [
    ...
    "- если изображение действительно нужно, ОБЯЗАТЕЛЬНО добавь после реплики один или несколько блоков:",
