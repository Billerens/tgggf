    ...
    fun requestOneToOneDiaryEntry(
        ...
        val systemPrompt =
            listOf(
                ...
                "Обычно пиши 2-4 абзаца; иногда допустим 1 короткий список (до 3 пунктов), если это звучит естественно.",
                "Заголовки и списки не запрещены, но используй их редко.",
